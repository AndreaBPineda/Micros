...
LOOP:
    ...
    btfss ((INTCON) and 07Fh), 2 ; Revisar si está activada la bandera del Timer0.
...
CONFIG_CLOCK:
    ...
    bcf OSCCON, 4 ; ((OSCCON) and 07Fh), 5
    bcf OSCCON, 5 ; ((OSCCON) and 07Fh), 6
    bsf OSCCON, 6 ; IRCF3
    return
...
CONFIG_TMR0:
    ...
    bcf ((INTCON) and 07Fh), 2 ; prescaler 256, y TMR0 = (256 - N)

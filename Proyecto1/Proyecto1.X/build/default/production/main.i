...
# 1 "/opt/microchip/xc8/v2.35/pic/include/xc.inc" 1 3
...
# 1 "/opt/microchip/xc8/v2.35/pic/include/pic.inc" 1 3



# 1 "/opt/microchip/xc8/v2.35/pic/include/pic_as_chip_select.inc" 1 3
# 2774 "/opt/microchip/xc8/v2.35/pic/include/pic_as_chip_select.inc" 3
# 1 "/opt/microchip/xc8/v2.35/pic/include/proc/pic16f887.inc" 1 3
# 48 "/opt/microchip/xc8/v2.35/pic/include/proc/pic16f887.inc" 3
INDF equ 0000h
...
EECON2 equ 018Dh
# 2819 "/opt/microchip/xc8/v2.35/pic/include/proc/pic16f887.inc" 3
...
# 2775 "/opt/microchip/xc8/v2.35/pic/include/pic_as_chip_select.inc" 2 3
# 5 "/opt/microchip/xc8/v2.35/pic/include/pic.inc" 2 3
...
auto_size SET 0
ENDM
# 8 "/opt/microchip/xc8/v2.35/pic/include/xc.inc" 2 3
# 30 "main.s" 2
...
RESET_TMR0 MACRO ; RESET TMR0
    ...
    BCF ((INTCON) and 07Fh), 2 ; Clear interruption flag TMR0
...
ISR: ; INTERRUPTIONS
    ...
    BTFSC ((INTCON) and 07Fh), 0 ; Check PORTB interruption flag
    CALL INT_PORTB ; Execute PORTB interruption on ((INTCON) and 07Fh), 0 = 1
    BTFSC ((INTCON) and 07Fh), 2 ; Check TMR0 interruption flag
    CALL INT_TMR0 ; Execute TMR0 interruption on ((INTCON) and 07Fh), 2 = 1
...
CONFIG_TMR0: ; TMR0 CONFIGURATION
    ...
    BCF ((OPTION_REG) and 07Fh), 5 ; Clean ((OPTION_REG) and 07Fh), 5
    BCF ((OPTION_REG) and 07Fh), 3 ; Enable counter
    BSF ((OPTION_REG) and 07Fh), 2 ; 1
    BSF ((OPTION_REG) and 07Fh), 1 ; 1 -> Prescaler 1:256
    BSF ((OPTION_REG) and 07Fh), 0 ; 1
...
CONFIG_IOCB: ; PORTB CONFIGURATION FOR PUSHBUTTONS
    ...
    BANKSEL PORTB
    BCF ((INTCON) and 07Fh), 0 ; Limpiar bandera de PORTB.
    RETURN

CONFIG_INT: ; INTERRUPTIONS CONFIGURATION

    BANKSEL INTCON ; Bank 0
    BSF ((INTCON) and 07Fh), 7 ; Enable global interruptions
    BSF ((INTCON) and 07Fh), 6 ; Enable periferic interruptions
    BCF ((INTCON) and 07Fh), 2 ; Clean TMR0 interruption flag
    BSF ((INTCON) and 07Fh), 5 ; Enable TMR0 interruptions
    BCF ((INTCON) and 07Fh), 0 ; Clean PORTB interruption flag
    BSF ((INTCON) and 07Fh), 3 ; Enable PORTB interruptions

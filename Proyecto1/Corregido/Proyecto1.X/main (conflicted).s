...
INCREASE_COUNT MACRO REG, PREV_REG
...
RESET_COUNT MACRO REG, LIMIT, START
...
RUN_CLK:
    ...
    BTFSC   STATUS, 0
    RETURN
    INCREASE_COUNT CLK_MIN, CLK_SEC
    
    MOVF    CLK_MIN
    SUBLW   59
    BTFSC   STATUS, 0
    RETURN
    INCREASE_COUNT  CLK_HRS, CLK_MIN
